...
public class PlayerSelectGUI extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        mageButton.setBackground(Config.COLOR_BLACK);
        ...
        archerButton.setBackground(Config.COLOR_BLACK);
        ...
        healerButton.setBackground(Config.COLOR_BLACK);
        ...
        warriorButton.setBackground(Config.COLOR_BLACK);
        ...
        ability2_name.setForeground(Config.COLOR_YELLOW);
        ...
        ability3_name.setForeground(Config.COLOR_YELLOW);
        ability3_name.setText("Ability3_name");

        ability1_desc.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ability1_desc.setForeground(Config.COLOR_YELLOW);
        ...
        ability2_desc.setForeground(Config.COLOR_YELLOW);
        ...
        ability3_desc.setForeground(Config.COLOR_YELLOW);
        ...
        ability5_name.setForeground(Config.COLOR_YELLOW);
        ability5_name.setText("Ability5_name");

        ability5_desc.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ability5_desc.setForeground(Config.COLOR_YELLOW);
        ...
        ability6_name.setForeground(Config.COLOR_YELLOW);
        ability6_name.setText("Ability6_name");

        ability6_desc.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        ability6_desc.setForeground(Config.COLOR_YELLOW);
    ...
    private void unhighlightAll()
    {
        ...
        for (javax.swing.JButton b : buttons) {
            b.setBackground(Config.COLOR_BLACK);
            b.setForeground(Config.COLOR_YELLOW);
            b.setBorder(javax.swing.BorderFactory.createLineBorder(Config.COLOR_YELLOW, 2));
    ...
    private void highlightSelected(javax.swing.JButton selected) {
        ...
        selected.setBackground(Config.COLOR_YELLOW);
        selected.setForeground(Config.COLOR_BLACK);
        selected.setBorder(javax.swing.BorderFactory.createLineBorder(Config.COLOR_YELLOW, 4));
    }
    ...
    private void infoPanel(PlayerClass hoveredClass){
        ...
        manaLabel.setText("Mana: " + hoveredClass.maxMana);
