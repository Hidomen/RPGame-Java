...
public class LobbyGUI extends javax.swing.JFrame {
    ...
    public LobbyGUI(GUICallback callback) {
    ...
    //if combat selected callback.setGUIState(GUIState.COMBAT);
    // shop callback.setGUIState(GUIState.SHOP);
    // exit callback.setGUIState(GUIState.EXIT);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new LobbyGUI(callback).setVisible(true));
    }
